                ...
                if car == '1' or car == 'bebida':
                    while True:
                        ...
                        if '1' in beb or 'suco de uva' in beb or 'uva' in beb:
                            contb = input('Ok gosteria de mais alguma coisa ?\n'
                                          '[1] = Sim    [2] = Não\n'
                                          'Informe aqui: ')
                            contb.lower()
                            ...
                            contb1 = input('Ok gosteria de mais alguma coisa ?\n'
                                          '[1] = Sim    [2] = Não\n'
                                          'Informe aqui: ')
                            contb1.lower()
                            ...
                            contb2 = input('Ok gosteria de mais alguma coisa ?\n'
                                          '[1] = Sim    [2] = Não\n'
                                          'Informe aqui: ')
                            contb2.lower()
...
if adeus1 == 'pedif':
    ...
    adeus2 = 'pedidof'
if adeus2 == 'pedidof':
    with open('pedidos.txt', 'a+', encoding='Utf-8', newline='')as arquivo:
...
if 'fun' in nome and '5544@' in senha:
    ...
    print(dobresa)
    print(15*'=')
    usu1 = (open('usuarios.txt', 'r'))
    print(usu1.read())
    usu1.seek(0)
    print(15*'=-')
    usu2 = (open('pedidos.txt', 'r'))
    print(usu2.read())
    usu2.seek(0)
if adeus == 'indo':
